...
public void testInterestWithSufficientDeposit() throws SQLException, ScriptException {
    ...
    // verify customer balance was increased by $7.50
    double CUSTOMER1_EXPECTED_FINAL_BALANCE = 507.5;
    double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
  ...
  /**
* Verifies deposit case where a customer receives interest after 5 sufficient deposits
* of 20 dollars while not being in overdraft.
*
* The customer's Balance should increase along with the deposits added by 1.015.
*
*
...
*/
@Test
public void testInterestWithEdgeCaseDeposit() throws SQLException, ScriptException {
    // initialize customer1 with a balance of 0
    double CUSTOMER1_BALANCE = 0;
    int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
    MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_BALANCE_IN_PENNIES, 0);
...
* of 5 dollars while not being in overdraft. This ensures that interest is only given for 5 deposits greater
* than 20 dollars
*
...
*/
@Test
public void testNoInterestWithInsufficientDeposit() throws SQLException, ScriptException {
    // initialize customer1 with a balance of $0
    double CUSTOMER1_BALANCE = 0;
    int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
    MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_BALANCE_IN_PENNIES, 0);

    // Prepare Deposit Form to Deposit $5 to customer 1's account.
    double CUSTOMER1_AMOUNT_TO_DEPOSIT = 5; // user input is in dollar amount, not pennies.
    User customer1DepositFormInputs = new User();
    customer1DepositFormInputs.setUsername(CUSTOMER1_ID);
    customer1DepositFormInputs.setPassword(CUSTOMER1_PASSWORD);
    customer1DepositFormInputs.setAmountToDeposit(CUSTOMER1_AMOUNT_TO_DEPOSIT); 
    ...
    // verify customer balance was not increased by $0.30
    double CUSTOMER1_EXPECTED_FINAL_BALANCE = 20.3;
    double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
  ...
  /**
* Verifies deposit case where a customer receives does not recieve interest after 5 insufficient deposits
* of 19.99 while not being in overdraft.
*
* The customer's Balance should not increase along with the interest by 1.015. The amount should remain the same
*
*
...
*/
@Test
public void testNoInterestWithEdgeCaseDeposit() throws SQLException, ScriptException {
    // initialize customer1 with a balance of $0
    double CUSTOMER1_BALANCE = 0;
    int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
    MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_BALANCE_IN_PENNIES, 0);
...
* of 20 dollars or more while not being in overdraft so no additional interest was added unnecessarily.
*
* The customer's Balance should  increase along with the interest by 1.015. The amount should remain the same.
*
*
* @throws SQLException
* @throws ScriptException
